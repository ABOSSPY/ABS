...
tlg1 = '''𝑊𝐸l𝐶𝑂𝑀 𝑇𝑂 𝑇𝐻𝐸 𝑇𝑂𝑂l★تم تفعيل الاداة من قبل المطور عبوسي ✅
━━━━━━━━━━━━━━━━━━
...
os.system('clear')
cetak(nel('\t• A B O S S تيم ⁨Ξ ASTR ⇝...•'))
...
'''
	...
	print(('—'*25)+'\n• DeCoDe By @A_B_A_S64 •\n'+('—'*25))
	cetak(nel(لوغو+لوغوعبوسي,style='red'))
	print(('—'*25)+'\n• DeCoDe By @A_B_A_S64 •\n'+('—'*25))
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s• A B O S S • %s/%s > OK %s > CP %s > %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
